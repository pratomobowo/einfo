                ...
                <div class="bg-white px-4 py-4">
                    ...
                    <div class="border-b border-gray-200 py-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <h4 class="text-sm font-medium text-gray-900">Dibuat Oleh</h4>
                                <p class="text-sm text-gray-600" x-text="activeActivity && activeActivity.creator ? activeActivity.creator.name : 'Admin'"></p>
                            </div>
                        </div>
                    </div>
