                        ...
                        <tbody>
                            ...
                            <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }} hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-600 border-b border-gray-200">
                                    ...
                                    <span class="px-3 py-1 inline-flex items-center rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                    ...
                                    <span class="px-3 py-1 inline-flex items-center rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 005 10a1 1 0 10-2 0c0 .53.087 1.037.225 1.544.346 1.19.872 2.208 1.496 2.976.62.764 1.38 1.369 2.236 1.801A6.99 6.99 0 0010 18a6.99 6.99 0 002.97-.679c.856-.432 1.615-1.037 2.235-1.801.624-.768 1.15-1.786 1.495-2.976A7.932 7.932 0 0017 10a1 1 0 10-2 0c0 .53-.11 1.036-.313 1.489A4.98 4.98 0 0010 11z" clip-rule="evenodd" />
                                        </svg>
                                        Admin Sekretariat
                                    </span>
                                    @else
                                    <span class="px-3 py-1 inline-flex items-center rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1 text-gray-600" viewBox="0 0 20 20" fill="currentColor">
