...
<div class="space-y-6">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">{{ __('Tambah Pengguna Baru') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Isi formulir di bawah untuk menambahkan pengguna baru ke sistem') }}</p>
        </div>
    </div>
