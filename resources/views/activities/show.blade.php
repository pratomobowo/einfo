            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <dl class="mt-4 space-y-4">
                        ...
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Surat Undangan/Tugas</dt>
                            <dd class="mt-1 text-sm text-gray-900">
                                @if($activity->assignment_letter)
                                    <a href="{{ route('activities.download_assignment_letter', $activity) }}" class="inline-flex items-center text-blue-600 hover:text-blue-900">
                                        ...
                                        Download Surat Undangan/Tugas
                                    </a>
                                @else
                                    <span class="text-gray-500">Tidak ada surat undangan/tugas</span>
                                @endif
                            </dd>
                        </div>
                    </dl>
