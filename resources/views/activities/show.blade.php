        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <a href="{{ route('activities.index') }}" class="text-indigo-600 hover:text-indigo-900">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">
                                        @if($activity->assignment_letter)
                                            <a href="{{ route('activities.download_assignment_letter', $activity) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-900">
